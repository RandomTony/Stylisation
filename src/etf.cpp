...
Point2f edgeTangentFlow(const Mat & isophote, const Mat & gHat, const int oRow, const int oColumn, const int radius) {
  int cRow, cColumn;
...
Mat computeETF(const Mat & iVectMap, const Mat & gHat, const int radius, int iteration) {
